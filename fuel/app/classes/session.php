 ...
 */
class Session  extends Fuel\Core\Agent
{
	/**
	...
	public static function instance($instance = null)
	{
		...
		// ↓セッション開始時の記述
		// Session::create();
		// Session::set("expire_on_close", true);　// ←パスワード保存しない場合に設定
		$close = (boolean) static::$_instance->get("expire_on_close");
		if ($close)
		{
			// 設定を上書き
			static::$_instance->set_config("expire_on_close", true);
		}
		// ▲ マリエッタ
